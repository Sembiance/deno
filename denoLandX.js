...
export {parse as xmlParse, stringify as xmlStringify} from "https://deno.land/x/xml@2.1.0/mod.ts";
...
export {connect as redisConnect} from "https://deno.land/x/redis@v0.29.2/mod.ts";

export {create as jwtCreate, getNumericDate} from "https://deno.land/x/djwt@v2.8/mod.ts";
