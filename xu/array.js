...
Array.prototype.max ||= function max()
{
	...
	// to avoid the spread operator failing with max call stack exceeded for large arrays, we do the math max thing manually
...
Array.prototype.min ||= function min()
{
	...
	// to avoid the spread operator failing with max call stack exceeded for large arrays, we do the math min thing manually
